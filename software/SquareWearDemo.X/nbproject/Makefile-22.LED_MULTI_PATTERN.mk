...
ifeq "$(wildcard nbproject/Makefile-local-22.LED_MULTI_PATTERN.mk)" "nbproject/Makefile-local-22.LED_MULTI_PATTERN.mk"
include nbproject/Makefile-local-22.LED_MULTI_PATTERN.mk
endif
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-22.LED_MULTI_PATTERN.mk dist/${CND_CONF}/${IMAGE_TYPE}/SquareWearDemo.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/SquareWearDemo.o: SquareWearDemo.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -DDEMO_LED_MULTI_PATTERN -ms -oa-  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/SquareWearDemo.o   SquareWearDemo.c 
...
${OBJECTDIR}/SquareWearDemo.o: SquareWearDemo.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/SquareWearDemo.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -DDEMO_LED_MULTI_PATTERN -ms -oa-  -I ${MP_CC_DIR}/../h  -fo ${OBJECTDIR}/SquareWearDemo.o   SquareWearDemo.c 
	@${DEP_GEN} -d ${OBJECTDIR}/SquareWearDemo.o 
	@${FIXDEPS} "${OBJECTDIR}/SquareWearDemo.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/22.LED_MULTI_PATTERN
	${RM} -r dist/22.LED_MULTI_PATTERN
